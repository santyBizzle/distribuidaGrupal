...
@NamedQueries({
	...
	@NamedQuery(name = "Customer.getById", query = "Select c from Customer c where id = :id"),
	@NamedQuery(name = "Customer.deleteById", query = "Select c from Customer c where id = :id")
})
